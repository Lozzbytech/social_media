...
<?php endif; ?>
    ...
    <div class="px-3 mt-5 md:mt-0 md:col-span-2">
        <form wire:submit.prevent="<?php echo e($submit); ?>">
            <div class="px-4 py-5 bg-white sm:p-6 shadow <?php echo e(isset($actions) ? 'sm:rounded-tl-md sm:rounded-tr-md' : 'sm:rounded-md'); ?> rounded rounded-lg rounded-b-none">
...
<?php /**PATH F:\social_media\simple-social-media-main\resources\views/vendor/jetstream/components/form-section.blade.php ENDPATH**/ ?>